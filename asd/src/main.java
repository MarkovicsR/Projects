...
public class main {
    public static void main(String[] args) {
        ...
        String[][] currentGameStatus = new String[][]{{"X", ".", "O"}, {".", "X", "O"}, {".", ".", "."}};
        //String[][] currentGameStatus = new String[][]{{"O", "X", "O"}, {"X", "X", "O"}, {"O", "O", "X"}};
        int currentPlayer = 0;
        printBoard(currentGameStatus);
        System.out.println(isFull(currentGameStatus));
        System.out.println(hasWon(currentGameStatus, currentPlayer));
    }
